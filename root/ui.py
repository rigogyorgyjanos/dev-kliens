...
TOGGLE_SWITCH_PATH = "d:/ymir work/ui/game/toggle_switch/special/"
...
class ToggleSwitch(Window):
	...
	def CreateElements(self):
		...
		self.backgroundImage.LoadImage(TOGGLE_SWITCH_PATH + "bg.png")
		self.backgroundImage.Show()
		...
		self.checkImage.LoadImage(TOGGLE_SWITCH_PATH + "unchecked.png")
		self.checkImage.Show()
		...
		if self.isAnimating:
			...
			if progress <= 1:
				...
				if self.isChecked:
					...
					self.checkImage.LoadImage(TOGGLE_SWITCH_PATH + "checked.png")
				else:
